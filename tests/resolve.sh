...
# Asked of the_program rather than spelled out again: the program moved
# from one file into a folder once, and a path written down twice goes
# stale in the copy nobody runs.
